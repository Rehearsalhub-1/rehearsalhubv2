...
export default function ConductorScreen({ route, navigation }: any) {
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={styles.header}>
          ...
          <Text style={[styles.headerText, { flex: 1, textAlign: 'center', marginHorizontal: 16 }]} numberOfLines={1} ellipsizeMode="tail">{activeTrack?.title || "Conductor's Guide"}</Text>
        ...
        <ScrollView
          ...
          {(() => {
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center', paddingTop: 60 }}>
              <Ionicons name="musical-notes-outline" size={64} color="rgba(255,255,255,0.2)" style={{ marginBottom: 16 }} />
              <Text style={[styles.fullTextLine, { textAlign: 'center', color: 'rgba(255,255,255,0.5)' }]}>
                No conductor guide has been added for this song yet.
              </Text>
            </View>
          );
          })()}
