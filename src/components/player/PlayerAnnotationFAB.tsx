...
export const PlayerAnnotationFAB: React.FC<PlayerAnnotationFABProps> = ({
  ...
  return (
    <View
      style={{ position: 'absolute', bottom: 110, right: 20, flexDirection: 'row', alignItems: 'flex-end', zIndex: 101, gap: 12 }}
    ...
    >
      ...
      {isAnnotationMode && showColorPalette && (
        <View
          style={{
            flexDirection: 'row', gap: 10, backgroundColor: 'rgba(0,0,0,0.85)',
            padding: 8, borderRadius: 24, alignItems: 'center',
            borderWidth: 1, borderColor: 'rgba(255,255,255,0.15)',
            shadowColor: '#000', shadowOffset: { width: 0, height: 2 },
            shadowOpacity: 0.3, shadowRadius: 4, elevation: 5, marginBottom: 6,
          }}
        >
          {COLORS.map((c) => {
